...
|-------|------|------|--------------|--------|
| 8 | Database Schema Migration | Modify exercises table and RLS policies | SCHEMA-01 to SCHEMA-09, RLS-01 to RLS-05 | Planned |
...
**Plans:**
- [ ] 08-01-PLAN.md -- Create migration SQL for schema changes, RLS policies, and indexes
...
| 8. Database Schema Migration | v2.7 | 0/1 | Planned | -- |
